package cn.funcoding.viewsample.ruler;
...
import cn.funcoding.viewsample.Utils;
...
public class RulerView extends ViewGroup {
    ...
    private InnerRulerView mRuleView;
    ...
    public void moveTranslationX(int translationX) {
        ...
        valueAnimator.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() {
            ...
            public void onAnimationUpdate(ValueAnimator animation) {
                String temp = String.format(Locale.CHINA, "%.1f", mRuleView.mCurrentValue);
    ...
    protected void onLayout(boolean changed, int l, int t, int r, int b) {
        ...
        mRuleView = (InnerRulerView) getChildAt(0);
        // 让尺子实现绘制100个单位
        int allWidth = (InnerRulerView.BIG_COUNT / (getWidth() / InnerRulerView.BIG_UNIT)) * getWidth();
        mRuleView.layout(l, mRulerTop, allWidth, mRulerBottom);
        mRuleView.setStartValue(1.0f * mCenterX / InnerRulerView.BIG_UNIT);
        mCurrentValue = String.format(Locale.CHINA, "%.1f", mRuleView.mCurrentValue);
    }
